	...
	<div class="primary content-area">
		...
		<div class="section regular-spacing">
			<div class="container section padding-bottom-border">
					...
					<!-- SIDEBAR -->
					<div class="col-4">
						<div class="popular-posts border-bottom mb-5">
							<h3><?php echo __('Most Popular' , 'gsc'); ?></h3>
					
							<?php 
							$popularpost = new WP_Query( array( 'posts_per_page' => 5, 'meta_key' => 'quanta_post_views_count', 'orderby' => 'meta_value_num', 'order' => 'DESC'  ) );
						...
						<div class="tags mt-5">
							...
							<div>
								...
								<?php 
									...
									foreach($tags as $tag):
								?>
									<li class="mb-2"><a class="underline" href="<?php echo $tag->slug; ?>"><?php echo strtolower($tag->name); ?></a></li>
								<?php endforeach; ?>
								</ul>
							</div>
						</div>
			...
			<div class="section half-padding">
				<div class="container">
					...
					<div class="row">
						<?php 
							$related = new WP_Query( array( 'posts_per_page' => 3 , 'orderby' => 'rand') );
